...
//#include <Particles/CommandFactory.hpp>
...
class Model final : public Process::ProcessModel
{
  ...
  PROCESS_METADATA_IMPL(Particles::Mesh::Model)
  W_OBJECT(Model)
...
using ProcessFactory = Process::ProcessFactory_T<Particles::Mesh::Model>;
...
SCORE_COMMAND_DECL_T(Particles::ChangeMeshFragmentShader)

PROPERTY_COMMAND_T(Particles, ChangeMesh, Mesh::Model::p_mesh, "Change model")
SCORE_COMMAND_DECL_T(Particles::ChangeMesh)
*/
